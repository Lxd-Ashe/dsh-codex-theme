...
function ThemePanel({ t, useStore, setThemePreset, setFont, resetTheme }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "codex-panel", "data-codex-theme-panel": true, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "codex-card", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeSelectRow, { id: "codex-light-preset", label: t("theme.light"), value: settings.lightPreset, presets: LIGHT_PRESETS, onChange: (index) => setThemePreset("light", index) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeSelectRow, { id: "codex-dark-preset", label: t("theme.dark"), value: settings.darkPreset, presets: DARK_PRESETS, onChange: (index) => setThemePreset("dark", index) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "codex-card", children: [
