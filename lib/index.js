...
var CodexSettingsSchema = Schema.object({
  lightPreset: Schema.number().default(DEFAULT_SETTINGS.lightPreset),
  darkPreset: Schema.number().default(DEFAULT_SETTINGS.darkPreset),
  uiFont: Schema.string().default(DEFAULT_SETTINGS.uiFont),
  uiFontSize: Schema.number().default(DEFAULT_SETTINGS.uiFontSize),
  workspaceFontSize: Schema.number().default(DEFAULT_SETTINGS.workspaceFontSize),
  codeFont: Schema.string().default(DEFAULT_SETTINGS.codeFont),
  codeFontSize: Schema.number().default(DEFAULT_SETTINGS.codeFontSize)
});
...
var cached = null;
var cachedAt = 0;
async function enumerateInstalledFonts() {
  ...
  try {
    ...
    for (const candidate of [...UI_FONT_CANDIDATES, ...CODE_FONT_CANDIDATES]) {
      ...
      if (matcher !== void 0 && [...faces].some((name2) => matcher.test(name2))) available.push(candidate);
    }
  } catch {
  }
  cached = available;
...
async function handleFontsRoute(_req, res) {
